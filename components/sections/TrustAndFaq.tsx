...
export function TrustAndFaq({ trustItems, faqItems }: TrustAndFaqProps) {
  ...
  const faqBottomBreathing = 'clamp(2.5rem, 5vw, 4rem)';

  return (
    <section className="relative w-full bg-[var(--color-dark)] py-[var(--spacing-section-y)] px-[var(--spacing-section-x)] overflow-hidden">
      ...
      <div className="w-full flex flex-col items-center relative z-10">
        ...
        <div className="w-32 h-px bg-[var(--color-gold)] opacity-30 my-[var(--spacing-xl)]" />
        ...
        <motion.div 
          ...
          style={{ paddingBottom: faqBottomBreathing }}
        >
          <RevealText
            as="h2"
            text="Preguntas Frecuentes"
            className="text-[var(--color-text-light)] font-serif text-[clamp(2rem,4vw,3.5rem)] !mb-[var(--spacing-lg)] text-center"
            delay={0.2}
          />
